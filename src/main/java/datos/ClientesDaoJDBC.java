...
public class ClientesDaoJDBC {
    ...
    //Para simplificar un poco el codigo vamos a hacrlo sin crear una interfaz
    ...
    public List<Cliente> listar() {
        ...
        try {
            ...
            //iteramos registro a registro obteniendo  el valor de sus campos
            while (rs.next()) {
                ...
                //instanciamos cleinte con estos valores
                cliente = new Cliente(idCliente, nombre, apellido, email, telefono, saldo);
                //añadimos cada requisito a nuestra lista convertido en un objeto clientes
